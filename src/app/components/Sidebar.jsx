...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col h-[552px] w-[211px] justify-between items-start bg-white border border-[#CFD8DE] rounded-[8px] py-4 px-0 overflow-y-auto flex-shrink-0">
