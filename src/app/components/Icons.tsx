...
export const ProfileDetailsIcon = () => (
  <img src="/sidebar_profile.png" alt="Profile Details" width="24" height="24" className="w-6 h-6 object-contain inline" />
);
...
export const ShortlistsIcon = () => (
  <img src="/sidebar_shortlists.png" alt="Shortlists" width="24" height="24" className="w-6 h-6 object-contain inline" />
);
...
export const DocumentsIcon = () => (
  <img src="/sidebar_documents.png" alt="Documents" width="24" height="24" className="w-6 h-6 object-contain inline" />
);

export const ReferEarnIcon = () => (
  <img src="/sidebar_refer.png" alt="Refer & Earn" width="24" height="24" className="w-6 h-6 object-contain inline" />
);
